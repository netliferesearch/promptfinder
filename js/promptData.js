...
export const addPrompt = async promptData => {
  ...
  try {
    const newPromptDocData = {
      ...
      averageRating: !promptData.isPrivate ? 0 : undefined, // Consider undefined for private
      totalRatingsCount: !promptData.isPrivate ? 0 : undefined,
      favoritesCount: !promptData.isPrivate ? 0 : undefined,
      usageCount: 0,
      createdAt: serverTimestamp(),
